---
name: daloopa__precedent-transactions
description: Precedent M&A transactions analysis with deal multiples and acquisition history
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/precedent-transactions`. Rebuild with skill-catalogue/package_plugins.py -->
