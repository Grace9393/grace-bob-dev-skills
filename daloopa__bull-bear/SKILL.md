---
name: daloopa__bull-bear
description: Bull/bear/base case scenario framework for a given company
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/bull-bear`. Rebuild with skill-catalogue/package_plugins.py -->
