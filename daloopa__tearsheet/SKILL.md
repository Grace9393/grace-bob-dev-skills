---
name: daloopa__tearsheet
description: Quick one-page company overview and snapshot
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/tearsheet`. Rebuild with skill-catalogue/package_plugins.py -->
