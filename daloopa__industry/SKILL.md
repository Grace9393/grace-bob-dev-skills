---
name: daloopa__industry
description: Cross-company industry comparison across multiple tickers
argument-hint: TICKER1 TICKER2 ...
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/industry`. Rebuild with skill-catalogue/package_plugins.py -->
