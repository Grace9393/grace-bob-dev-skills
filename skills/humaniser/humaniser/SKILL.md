...
Key insight from Wikipedia: "LLMs use statistical algorithms to guess what should come next. The result tends towards the most statistically likely result that applies to the widest variety of cases."
