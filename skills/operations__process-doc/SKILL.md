...
---
<!-- packaged from the Claude plugin export: plugin `operations`, original path `plugins/operations/skills/process-doc`. Rebuild with skill-catalogue/package_plugins.py -->
