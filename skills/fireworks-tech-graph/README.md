...
Works with both **Claude Code** and **IBM Bob** — same SKILL.md, pick the target agent:

```bash
# Interactive (choose agents when prompted)
npx skills add yizhiyanhua-ai/fireworks-tech-graph

# Claude Code (project .claude/skills/, or add -g for ~/.claude/skills/)
npx skills add yizhiyanhua-ai/fireworks-tech-graph -a claude-code

# IBM Bob (project .bob/skills/, or add -g for ~/.bob/skills/)
npx skills add yizhiyanhua-ai/fireworks-tech-graph -a bob
```

**Manual (no npx):** copy this repo folder into `~/.claude/skills/fireworks-tech-graph/` (Claude Code) or `~/.bob/skills/fireworks-tech-graph/` (IBM Bob). The Python renderer dependencies below apply to either agent.
