---
name: daloopa__capital-allocation
description: Deep dive into capital deployment, buybacks, dividends, and shareholder yield
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/capital-allocation`. Rebuild with skill-catalogue/package_plugins.py -->
