#!/usr/bin/env python3
"""
Create SQLite FTS5 database from GDS Service Manual markdown files.
"""
...
REFERENCES_DIR = SKILL_DIR / "references" / "service-manual"
DB_FILE = SKILL_DIR / "gds-service-manual.sqlite"
SQL_SCHEMA_FILE = SCRIPT_DIR / "db.sql"
DEBUG_DUMP_DIR = Path("~/tmp/gds-tmp").expanduser()
REMOVE_SECTIONS = {
