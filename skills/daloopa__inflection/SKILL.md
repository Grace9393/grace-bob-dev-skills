---
name: daloopa__inflection
description: Auto-detect biggest acceleration/deceleration inflections across all metrics
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/inflection`. Rebuild with skill-catalogue/package_plugins.py -->
