---
name: operations__process-optimization
...
---
<!-- packaged from the Claude plugin export: plugin `operations`, original path `plugins/operations/skills/process-optimization`. Rebuild with skill-catalogue/package_plugins.py -->
