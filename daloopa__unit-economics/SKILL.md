---
name: daloopa__unit-economics
description: Bottoms-up unit economics decomposition for any public company
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/unit-economics`. Rebuild with skill-catalogue/package_plugins.py -->
