---
name: daloopa__guidance-tracker
description: Track management guidance accuracy over time for a given company
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/guidance-tracker`. Rebuild with skill-catalogue/package_plugins.py -->
