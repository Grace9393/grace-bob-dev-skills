---
name: operations__risk-assessment
...
---
<!-- packaged from the Claude plugin export: plugin `operations`, original path `plugins/operations/skills/risk-assessment`. Rebuild with skill-catalogue/package_plugins.py -->
