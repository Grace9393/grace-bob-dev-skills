---
name: daloopa__working-capital
description: Cash conversion cycle, earnings quality, and working capital deep-dive
argument-hint: TICKER
---
<!-- packaged from the Claude plugin export: plugin `daloopa`, original path `plugins/daloopa/skills/working-capital`. Rebuild with skill-catalogue/package_plugins.py -->
